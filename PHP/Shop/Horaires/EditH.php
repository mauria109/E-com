<?php
    ...
    if (isset($DB) && !empty($_POST)){
        ...
        $insert = $DB->Querries("UPDATE ouverture SET debut = '$_POST[lundi_d]',
                     fin = '$_POST[lundi_f]' WHERE jour = 'Lundi', ");
        
        if ($insert){
            echo "<h1>Enregistrement des modifications des horaires réussi</h1>";
        }else{
            echo "<h1>Echec de l'enregistrement des modifications des horaires !!</h1>";
        }
    }
?>
<!DOCTYPE html>
