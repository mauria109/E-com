        ...
        if ($mt == true){
            ...
            if ($vend){
                ...
                if (empty($errors)){
                    ...
                    $check = $DB->SelectQuerry("SELECT id_vend FROM vendeur WHERE mail_vend = '$_POST[mail]' ") ;
                    $insert = $DB->Querries("UPDATE vendeur SET
                   pseudo_vend = '$_POST[pseudo]', mail_vend = '$_POST[mail]',
                   tel_vend = '$_POST[num]', mdp_vend = '$pwd' WHERE id_vend = '$check' ");
