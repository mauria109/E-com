    ...
    <body>
        ...
        <section>
            <aside>
                <nav>
                    <ul>
                        <li class="index-nav"><a href = "VHome.php">
            ...
            <?php
                if (isset($DB, $_GET['vend'])){
                    $vend = $_GET['vend'];
                    $view = $DB->SelectQuerry("SELECT * FROM vendeur WHERE id_vend = '$vend'");
                }
            ?>
            <article>
                <h1>Bonjour!!!</h1>
                <p class="pseudo">
                    Pseudo
                    <?php if (isset($view)){ echo $view->pseudo_vend;} ?>
                </p>
                
                <p class="email">
                    Email
                    <?php if (isset($view)){ echo $view->mail_vend; }?>
                </p>
                
                <p class="mdp">
                    Mot de passe
                    <?php if (isset($view)){ echo $view->mdp_vend; }?>
                </p>
    
                <p class="mdp">
                    Telephone
                    <?php if (isset($view)){ echo $view->tel_vend; }?>
                </p>
            </article>
        </section>
        <hr>
